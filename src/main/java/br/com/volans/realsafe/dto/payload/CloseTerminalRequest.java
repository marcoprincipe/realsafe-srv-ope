...
/**
 * DTO para chamada do serviço de fechemento do terminal.
 * 
 * @author Volans Informática Ltda.
 */

public class CloseTerminalRequest implements Serializable {

	/**
	 * Declaração da serial version.
	 */
	
	private static final long serialVersionUID = 3064595126222102484L;
	...
	public String toString() {
		...
		builder.append("CloseTerminalRequest [groupOwnerId=");
