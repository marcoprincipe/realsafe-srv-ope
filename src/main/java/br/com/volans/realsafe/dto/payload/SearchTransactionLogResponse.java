...
public class SearchTransactionLogResponse implements Serializable {

	/**
	 * Declaração da serial version.
	 */
	
	private static final long serialVersionUID = 3997529890228362420L;
	...
	public SearchTransactionLogResponse() {
	...
	public SearchTransactionLogResponse(List<TransactionLogDTO> transactionLogs) {
	...
	public String toString() {
		...
		builder.append("SearchTransactionLogResponse [transactionLogs=");
